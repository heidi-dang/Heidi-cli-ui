  ...
  return (
    <div className="w-full flex flex-col h-full bg-black/40 backdrop-blur-md">
      ...
      <div className="p-3 space-y-1 shrink-0">
        ...
        >
          <div className={`p-1.5 rounded-lg ${currentView === 'gemini' ? 'bg-purple-500/20 text-purple-300' : 'bg-white/5 text-slate-500 group-hover:text-slate-300'}`}>
             <Sparkles size={16} />
          </div>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        <div className="px-5 pt-4 pb-2 flex items-center justify-between text-slate-400 shrink-0">
            <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500/80">Heidi Runs</span>
            <button 
                onClick={fetchRuns} 
